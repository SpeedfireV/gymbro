...
export function TrainingSelector({ navigation }: StackScreenProps<RootStackParamList, 'TrainingSelector'>){
    ...
    const dummyTrainings : TrainingItem[] = [
            ...
            duration: '4 h 20 min',
            exercises: [
                { id: 'c1', name: 'Cardio', muscle: "Biceps", detail: '45 min', order: 3, type: "excercise" },
