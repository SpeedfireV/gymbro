...
export function TrainingPage({ navigation }: StackScreenProps<RootStackParamList, 'Training'>){
    ...
    const dummyTrainings : TrainingItem[] = [
            ...
            duration: '4 h 20 min',
            exercises: [
                { id: 'e1', name: 'Cardio', muscle: "Heart", detail: '45 min', order: 1, type: "excercise"},
                { id: 'e2', name: 'Incline Bench Press', muscle: "Biceps", detail: '4x12', order: 2, type: "excercise"},
                { id: 'e3', name: 'Cardio', muscle: "Heart", detail: '45 min', order: 3, type: "excercise"},
                { id: 'e4', name: 'Incline Bench Press', muscle: "Biceps", detail: '4x12', order: 4, type: "excercise"},
            ],
            isPublic: true,
            },
            {
            ...
            duration: '4 h 20 min',
            exercises: [
                { id: 'c1', name: 'Cardio', muscle: "Heart", detail: '45 min', order: 3, type: "excercise"},
                { id: 'c2', name: 'Incline Bench Press', muscle: "Biceps", detail: '4x12', order: 4, type: "excercise"},
            ],
            isPublic: true,
            },
        ];
    ...
    const renderItem = ({ item }: { item: TrainingItem }) => (
        <ShortTrainingTile 
            ...
            showPublicity = {false}
            onSelect={(training) => navigation.navigate('TrainingDetail', { training })} 
        />
    );
    ...
    <View style={styles.container}>
        ...
        <View style={styles.content}>
            ...
            <FlatList
                data={PersonalActive ? dummyTrainings: dummyTrainings2}
